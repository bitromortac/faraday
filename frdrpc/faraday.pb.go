...
type ForwardingAbilityRequest struct {
	...
	LiquidityFloorSat uint64 `protobuf:"varint,4,opt,name=liquidity_floor_sat,json=liquidityFloorSat,proto3" json:"liquidity_floor_sat,omitempty"`
}
...
type ForwardingAbilityResponse struct {
	...
	// Sparse list of forwarding ability entries. An entry is present only when
	// its effective_uptime_s or forwarded_sat is non-zero. A peer pair absent
	// from this list had zero effective uptime and zero forwarded volume over
	// [start_time, end_time). Absence means zero, not unknown.
...
type ForwardingAbilityEntry struct {
	...
	EffectiveUptimeS int64 `protobuf:"varint,5,opt,name=effective_uptime_s,json=effectiveUptimeS,proto3" json:"effective_uptime_s,omitempty"`
	// Total successfully forwarded amount over the window, in satoshis.
	ForwardedSat int64 `protobuf:"varint,6,opt,name=forwarded_sat,json=forwardedSat,proto3" json:"forwarded_sat,omitempty"`
}
...
var file_faraday_proto_rawDesc = []byte{
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x9e, 0x01, 0x0a, 0x18, 0x46,
	...
	,
	...
	,
