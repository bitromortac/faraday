...
func (CloseRecommendationRequest_Metric) EnumDescriptor() ([]byte, []int) {
	return file_faraday_proto_rawDescGZIP(), []int{2, 0}
}
...
type ForwardingAbility struct {
	...
	// The forwarding velocity in sat/s during effective uptime.
	Velocity float64 `protobuf:"fixed64,1,opt,name=velocity,proto3" json:"velocity,omitempty"`
	// The fraction of time the channel was considered effective.
	UptimeFraction float64 `protobuf:"fixed64,2,opt,name=uptime_fraction,json=uptimeFraction,proto3" json:"uptime_fraction,omitempty"`
}

func (x *ForwardingAbility) Reset() {
	*x = ForwardingAbility{}
...
func (x *ForwardingAbility) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForwardingAbility) ProtoMessage() {}

func (x *ForwardingAbility) ProtoReflect() protoreflect.Message {
	mi := &file_faraday_proto_msgTypes[0]
...
// Deprecated: Use ForwardingAbility.ProtoReflect.Descriptor instead.
func (*ForwardingAbility) Descriptor() ([]byte, []int) {
	return file_faraday_proto_rawDescGZIP(), []int{0}
}

func (x *ForwardingAbility) GetVelocity() float64 {
	if x != nil {
		return x.Velocity
	}
	return 0
...
func (x *ForwardingAbility) GetUptimeFraction() float64 {
	if x != nil {
		return x.UptimeFraction
	}
	return 0
}

type ForwardingAbilityPair struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The public key of the incoming peer.
	PeerIn string `protobuf:"bytes,1,opt,name=peer_in,json=peerIn,proto3" json:"peer_in,omitempty"`
	// The public key of the outgoing peer.
	PeerOut string `protobuf:"bytes,2,opt,name=peer_out,json=peerOut,proto3" json:"peer_out,omitempty"`
	// The forwarding ability of the peer pair.
	Ability *ForwardingAbility `protobuf:"bytes,3,opt,name=ability,proto3" json:"ability,omitempty"`
}

func (x *ForwardingAbilityPair) Reset() {
	*x = ForwardingAbilityPair{}
	if protoimpl.UnsafeEnabled {
...
func (x *ForwardingAbilityPair) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForwardingAbilityPair) ProtoMessage() {}

func (x *ForwardingAbilityPair) ProtoReflect() protoreflect.Message {
	mi := &file_faraday_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ForwardingAbilityPair.ProtoReflect.Descriptor instead.
func (*ForwardingAbilityPair) Descriptor() ([]byte, []int) {
	return file_faraday_proto_rawDescGZIP(), []int{1}
}

func (x *ForwardingAbilityPair) GetPeerIn() string {
	if x != nil {
		return x.PeerIn
	}
	return ""
...
func (x *ForwardingAbilityPair) GetPeerOut() string {
	if x != nil {
		return x.PeerOut
	}
	return ""
...
func (x *ForwardingAbilityPair) GetAbility() *ForwardingAbility {
	if x != nil {
		return x.Ability
	}
	return nil
...
type ChannelEventsRequest struct {
	...
	ChanPoint string `protobuf:"bytes,1,opt,name=chan_point,json=chanPoint,proto3" json:"chan_point,omitempty"`
	// The start time of the query range, expressed as unix epoch offset in
	// seconds.
	StartTime uint64 `protobuf:"varint,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// The end time of the query range, expressed as unix epoch offset in seconds.
	EndTime uint64 `protobuf:"varint,3,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	// An optional list of event types to filter by. If empty, all event types will
	// be returned.
	EventTypes []ChannelEventType `protobuf:"varint,4,rep,packed,name=event_types,json=eventTypes,proto3,enum=frdrpc.ChannelEventType" json:"event_types,omitempty"`
}
...
func (x *ChannelEventsRequest) GetStartTime() uint64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *ChannelEventsRequest) GetEndTime() uint64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
func (x *ChannelEventsRequest) GetEventTypes() []ChannelEventType {
	if x != nil {
		return x.EventTypes
	}
	return nil
...
func (x *ChannelEvent) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type ForwardingAbilityRequest struct {
	...
	// The end time of the query range, expressed as unix epoch offset in seconds.
	EndTime uint64 `protobuf:"varint,2,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	// The percentile of successful forward amounts to use as a threshold for
	// determining routable liquidity.
	ForwardPercentile float32 `protobuf:"fixed32,3,opt,name=forward_percentile,json=forwardPercentile,proto3" json:"forward_percentile,omitempty"`
	// The threshold amount in satoshis to use for determining routable liquidity.
	ThresholdAmtSat uint64 `protobuf:"varint,4,opt,name=threshold_amt_sat,json=thresholdAmtSat,proto3" json:"threshold_amt_sat,omitempty"`
}
...
func (x *ForwardingAbilityRequest) GetForwardPercentile() float32 {
	if x != nil {
		return x.ForwardPercentile
	}
	return 0
}

func (x *ForwardingAbilityRequest) GetThresholdAmtSat() uint64 {
	if x != nil {
		return x.ThresholdAmtSat
	}
	return 0
}
...
type ForwardingAbilityResponse struct {
	...
	// The forwarding ability for each peer pair.
	Pairs []*ForwardingAbilityPair `protobuf:"bytes,1,rep,name=pairs,proto3" json:"pairs,omitempty"`
}

func (x *ForwardingAbilityResponse) Reset() {
	*x = ForwardingAbilityResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_faraday_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ForwardingAbilityResponse) Descriptor() ([]byte, []int) {
	return file_faraday_proto_rawDescGZIP(), []int{28}
}

func (x *ForwardingAbilityResponse) GetPairs() []*ForwardingAbilityPair {
	if x != nil {
		return x.Pairs
	}
	return nil
...
var file_faraday_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x28, 0x02, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x72, 0x65, 0x63,
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x5f, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0e, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x43, 0x6c, 0x6f,
	0x73, 0x65, 0x22, 0x71, 0x0a, 0x14, 0x52, 0x65, 0x76, 0x65, 0x6e, 0x75, 0x65, 0x52, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x68,
	0x61, 0x6e, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0a, 0x63, 0x68, 0x61, 0x6e, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x73,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x48, 0x0a, 0x15, 0x52, 0x65, 0x76, 0x65, 0x6e, 0x75, 0x65,
	...
	,
	...
	0x72, 0x65, 0x6e, 0x63, 0x79, 0x22, 0x5f, 0x0a, 0x0c, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67,
	...
	0x61, 0x6d, 0x70, 0x12, 0x31, 0x0a, 0x09, 0x62, 0x74, 0x63, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x66, 0x72, 0x64, 0x72, 0x70, 0x63, 0x2e,
	0x42, 0x69, 0x74, 0x63, 0x6f, 0x69, 0x6e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x08, 0x62, 0x74,
	0x63, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0xe4, 0x02, 0x0a, 0x10, 0x4e, 0x6f, 0x64, 0x65, 0x41,
	0x75, 0x64, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x39, 0x0a, 0x0b, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x66, 0x72, 0x64, 0x72, 0x70, 0x63, 0x2e, 0x43,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x0a, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0x45, 0x0a, 0x15, 0x43,
	...
	0x74, 0x73, 0x22, 0xb1, 0x01, 0x0a, 0x0c, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x45, 0x76,
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x66, 0x72, 0x64, 0x72, 0x70, 0x63, 0x2e, 0x43,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x09, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x6c, 0x6f,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x42,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x18, 0x46, 0x6f, 0x72, 0x77, 0x61,
	0x72, 0x64, 0x69, 0x6e, 0x67, 0x41, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x55, 0x52, 0x53, 0x10, 0x07, 0x12, 0x07, 0x0a, 0x03, 0x44, 0x41, 0x59, 0x10, 0x08, 0x2a, 0x5c,
	...
	0x09, 0x43, 0x4f, 0x49, 0x4e, 0x47, 0x45, 0x43, 0x4b, 0x4f, 0x10, 0x04, 0x2a, 0xa2, 0x02, 0x0a,
	...
	,
	...
	,
	...
	0x67, 0x6c, 0x61, 0x62, 0x73, 0x2f, 0x66, 0x61, 0x72, 0x61, 0x64, 0x61, 0x79, 0x2f, 0x66, 0x72,
...
var file_faraday_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_faraday_proto_goTypes = []any{
	...
	(*ForwardingAbility)(nil),               // 5: frdrpc.ForwardingAbility
	(*ForwardingAbilityPair)(nil),           // 6: frdrpc.ForwardingAbilityPair
	(*CloseRecommendationRequest)(nil),      // 7: frdrpc.CloseRecommendationRequest
	(*OutlierRecommendationsRequest)(nil),   // 8: frdrpc.OutlierRecommendationsRequest
	(*ThresholdRecommendationsRequest)(nil), // 9: frdrpc.ThresholdRecommendationsRequest
	(*CloseRecommendationsResponse)(nil),    // 10: frdrpc.CloseRecommendationsResponse
	(*Recommendation)(nil),                  // 11: frdrpc.Recommendation
	(*RevenueReportRequest)(nil),            // 12: frdrpc.RevenueReportRequest
	(*RevenueReportResponse)(nil),           // 13: frdrpc.RevenueReportResponse
	(*RevenueReport)(nil),                   // 14: frdrpc.RevenueReport
	(*PairReport)(nil),                      // 15: frdrpc.PairReport
	(*ChannelInsightsRequest)(nil),          // 16: frdrpc.ChannelInsightsRequest
	(*ChannelInsightsResponse)(nil),         // 17: frdrpc.ChannelInsightsResponse
	(*ChannelInsight)(nil),                  // 18: frdrpc.ChannelInsight
	(*ExchangeRateRequest)(nil),             // 19: frdrpc.ExchangeRateRequest
	(*ExchangeRateResponse)(nil),            // 20: frdrpc.ExchangeRateResponse
	(*BitcoinPrice)(nil),                    // 21: frdrpc.BitcoinPrice
	(*ExchangeRate)(nil),                    // 22: frdrpc.ExchangeRate
	(*NodeAuditRequest)(nil),                // 23: frdrpc.NodeAuditRequest
	(*CustomCategory)(nil),                  // 24: frdrpc.CustomCategory
	(*ReportEntry)(nil),                     // 25: frdrpc.ReportEntry
	(*NodeAuditResponse)(nil),               // 26: frdrpc.NodeAuditResponse
	(*CloseReportRequest)(nil),              // 27: frdrpc.CloseReportRequest
	(*CloseReportResponse)(nil),             // 28: frdrpc.CloseReportResponse
	(*ChannelEventsRequest)(nil),            // 29: frdrpc.ChannelEventsRequest
	(*ChannelEventsResponse)(nil),           // 30: frdrpc.ChannelEventsResponse
	(*ChannelEvent)(nil),                    // 31: frdrpc.ChannelEvent
	(*ForwardingAbilityRequest)(nil),        // 32: frdrpc.ForwardingAbilityRequest
	(*ForwardingAbilityResponse)(nil),       // 33: frdrpc.ForwardingAbilityResponse
	nil,                                     // 34: frdrpc.RevenueReport.PairReportsEntry
}
var file_faraday_proto_depIdxs = []int32{
	5,  // 0: frdrpc.ForwardingAbilityPair.ability:type_name -> frdrpc.ForwardingAbility
	4,  // 1: frdrpc.CloseRecommendationRequest.metric:type_name -> frdrpc.CloseRecommendationRequest.Metric
	7,  // 2: frdrpc.OutlierRecommendationsRequest.rec_request:type_name -> frdrpc.CloseRecommendationRequest
	7,  // 3: frdrpc.ThresholdRecommendationsRequest.rec_request:type_name -> frdrpc.CloseRecommendationRequest
	11, // 4: frdrpc.CloseRecommendationsResponse.recommendations:type_name -> frdrpc.Recommendation
	14, // 5: frdrpc.RevenueReportResponse.reports:type_name -> frdrpc.RevenueReport
	34, // 6: frdrpc.RevenueReport.pair_reports:type_name -> frdrpc.RevenueReport.PairReportsEntry
	18, // 7: frdrpc.ChannelInsightsResponse.channel_insights:type_name -> frdrpc.ChannelInsight
	0,  // 8: frdrpc.ExchangeRateRequest.granularity:type_name -> frdrpc.Granularity
	1,  // 9: frdrpc.ExchangeRateRequest.fiat_backend:type_name -> frdrpc.FiatBackend
	21, // 10: frdrpc.ExchangeRateRequest.custom_prices:type_name -> frdrpc.BitcoinPrice
	22, // 11: frdrpc.ExchangeRateResponse.rates:type_name -> frdrpc.ExchangeRate
	21, // 12: frdrpc.ExchangeRate.btc_price:type_name -> frdrpc.BitcoinPrice
	0,  // 13: frdrpc.NodeAuditRequest.granularity:type_name -> frdrpc.Granularity
	24, // 14: frdrpc.NodeAuditRequest.custom_categories:type_name -> frdrpc.CustomCategory
	1,  // 15: frdrpc.NodeAuditRequest.fiat_backend:type_name -> frdrpc.FiatBackend
	21, // 16: frdrpc.NodeAuditRequest.custom_prices:type_name -> frdrpc.BitcoinPrice
	2,  // 17: frdrpc.ReportEntry.type:type_name -> frdrpc.EntryType
	21, // 18: frdrpc.ReportEntry.btc_price:type_name -> frdrpc.BitcoinPrice
	25, // 19: frdrpc.NodeAuditResponse.reports:type_name -> frdrpc.ReportEntry
	3,  // 20: frdrpc.ChannelEventsRequest.event_types:type_name -> frdrpc.ChannelEventType
	31, // 21: frdrpc.ChannelEventsResponse.events:type_name -> frdrpc.ChannelEvent
	3,  // 22: frdrpc.ChannelEvent.event_type:type_name -> frdrpc.ChannelEventType
	6,  // 23: frdrpc.ForwardingAbilityResponse.pairs:type_name -> frdrpc.ForwardingAbilityPair
	15, // 24: frdrpc.RevenueReport.PairReportsEntry.value:type_name -> frdrpc.PairReport
	8,  // 25: frdrpc.FaradayServer.OutlierRecommendations:input_type -> frdrpc.OutlierRecommendationsRequest
	9,  // 26: frdrpc.FaradayServer.ThresholdRecommendations:input_type -> frdrpc.ThresholdRecommendationsRequest
	12, // 27: frdrpc.FaradayServer.RevenueReport:input_type -> frdrpc.RevenueReportRequest
	16, // 28: frdrpc.FaradayServer.ChannelInsights:input_type -> frdrpc.ChannelInsightsRequest
	19, // 29: frdrpc.FaradayServer.ExchangeRate:input_type -> frdrpc.ExchangeRateRequest
	23, // 30: frdrpc.FaradayServer.NodeAudit:input_type -> frdrpc.NodeAuditRequest
	27, // 31: frdrpc.FaradayServer.CloseReport:input_type -> frdrpc.CloseReportRequest
	29, // 32: frdrpc.FaradayServer.GetChannelEvents:input_type -> frdrpc.ChannelEventsRequest
	32, // 33: frdrpc.FaradayServer.ForwardingAbility:input_type -> frdrpc.ForwardingAbilityRequest
	10, // 34: frdrpc.FaradayServer.OutlierRecommendations:output_type -> frdrpc.CloseRecommendationsResponse
	10, // 35: frdrpc.FaradayServer.ThresholdRecommendations:output_type -> frdrpc.CloseRecommendationsResponse
	13, // 36: frdrpc.FaradayServer.RevenueReport:output_type -> frdrpc.RevenueReportResponse
	17, // 37: frdrpc.FaradayServer.ChannelInsights:output_type -> frdrpc.ChannelInsightsResponse
	20, // 38: frdrpc.FaradayServer.ExchangeRate:output_type -> frdrpc.ExchangeRateResponse
	26, // 39: frdrpc.FaradayServer.NodeAudit:output_type -> frdrpc.NodeAuditResponse
	28, // 40: frdrpc.FaradayServer.CloseReport:output_type -> frdrpc.CloseReportResponse
	30, // 41: frdrpc.FaradayServer.GetChannelEvents:output_type -> frdrpc.ChannelEventsResponse
	33, // 42: frdrpc.FaradayServer.ForwardingAbility:output_type -> frdrpc.ForwardingAbilityResponse
...
func file_faraday_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_faraday_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*ForwardingAbility); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_faraday_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ForwardingAbilityPair); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_faraday_proto_msgTypes[28].Exporter = func(v any, i int) any {
